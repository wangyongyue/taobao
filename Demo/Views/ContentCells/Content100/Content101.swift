...
import UIKit
import VueSwift
class Content101: UITableViewCell {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is Content101Model{
            let m = aModel as! Content101Model
            
            var array = Array<VueData>()
            array.append(ContentSub101Model())
            array.append(ContentSub101Model())
            array.append(ContentSub101Model())
            array.append(ContentSub101Model())
