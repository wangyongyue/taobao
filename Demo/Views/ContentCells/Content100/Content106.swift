...
import UIKit
import VueSwift
class Content106: UITableViewCell {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is Content106Model{
            
            let m = aModel as! Content106Model
            
            var array = Array<VueData>()
            array.append(ContentSub103Model())
            array.append(ContentSub103Model())
            array.append(ContentSub103Model())
            array.append(ContentSub103Model())
            array.append(ContentSub103Model())
